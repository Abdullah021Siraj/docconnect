...
export const PaymentSuccess = ({ type, bookingDetails, roomId }: PaymentSuccessProps) => {
  ...
  return (
    <div className="flex justify-center items-center min-h-screen bg-gray-50">
      <Card className="w-[600px] p-8 border-2 border-green-200">
            ...
            <div className="space-y-3">
              ...
              {roomId && (
                <div className="mt-4 p-3 bg-blue-50 rounded">
                  ...
                  <p className="text-sm text-gray-600">Use this Room ID to join your video consultation</p>
                </div>
              )}
            </div>
          ) : (
        ...
        <div className="space-y-4">
          <Button onClick={() => router.push("/user")} className="w-full bg-green-600 hover:bg-green-700">
            Go to Dashboard
          </Button>
