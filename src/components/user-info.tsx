      ...
      <Card className="p-4 md:p-6 border border-gray-200 shadow-sm">
        ...
        <CardContent className="space-y-4">
          <div className="flex flex-col md:flex-row items-center md:justify-between rounded-lg border p-3 shadow-sm bg-gray-50">
            ...
            <p className="truncate text-xs max-w-full md:max-w-[250px] font-mono p-1 rounded-md break-all">
              {user?.id}
            </p>
          </div>
          <div className="flex flex-col md:flex-row items-center md:justify-between rounded-lg border p-3 shadow-sm bg-gray-50">
            <p className="text-sm font-medium">Name</p>
            <p className="truncate text-xs max-w-full md:max-w-[250px] font-mono p-1 rounded-md break-words">
              {user?.name}
            </p>
          </div>
          <div className="flex flex-col md:flex-row items-center md:justify-between rounded-lg border p-3 shadow-sm bg-gray-50">
          ...
          <div className="flex flex-col md:flex-row items-center md:justify-between rounded-lg border p-3 shadow-sm bg-gray-50">
            ...
            <p className="truncate text-xs max-w-full md:max-w-[250px] font-mono p-1 rounded-md">
              {user?.role}
            </p>
          </div>
          <div className="flex flex-col md:flex-row items-center md:justify-between rounded-lg border p-3 shadow-sm bg-gray-50">
